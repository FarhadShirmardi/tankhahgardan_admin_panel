...
class Gregorian2Jalali
{
    ...
    */
    ...
    public function jalaliToGregorian($j_y, $j_m, $j_d, $str)
    {
        $g_days_in_month = array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
        $j_days_in_month = array(31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29);
    ...
    public function comparedate($_date_mix_jalaly, $_date_mix_gregorian)
    {
        ...
        if ($_date_arr_gregorian[0] > $arr_jtg[0]) {
            ...
            return false;
        } elseif ($_date_arr_gregorian[0] == $arr_jtg[0] &&
            $_date_arr_gregorian[1] == $arr_jtg[1] && $_date_arr_gregorian[2] > $arr_jtg[2]) {
            return false;
        }
        return true;
    }
