    ...
    <div class="tab-content">
        <div class="tab-pane active" id="timeline" role="tabpanel">
            ...
            <div class="callout callout-success m-0 py-3">
                <div>
                    <strong>#10 استارتاپ</strong>جلسه
                </div>
                <small class="text-muted mr-3"><i class="icon-calendar"></i>&nbsp; 1 - 3pm</small>
                <small class="text-muted"><i class="icon-location-pin"></i>&nbsp; Palo Alto, CA</small>
            </div>
        ...
        <div class="tab-pane p-3" id="messages" role="tabpanel">
            <div class="message">
                ...
                <small class="text-muted">لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به متنی آزمایشی و بی‌معنی در
                    صنعت...
                </small>
            </div>
            <hr>
        ...
        <div class="tab-pane p-3" id="settings" role="tabpanel">
            ...
            <div class="aside-options">
                ...
                <div>
                    <small class="text-muted">لورم ایپسوم یا طرح‌نما (به انگلیسی: Lorem ipsum) به متنی آزمایشی و بی‌معنی
                        در صنعت چاپ، صفحه‌آرایی و طراحی گرافیک گفته می‌شود. طراح گرافیک از این متن به عنوان عنصری از
                        ترکیب بندی برای پر کردن صفحه و ارایه اولیه شکل ظاهری و کلی طرح سفارش گرفته شده استفاده می نماید
                    </small>
                </div>
            </div>
