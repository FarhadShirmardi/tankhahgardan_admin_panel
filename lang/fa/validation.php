...
return [
    'captcha' => 'کد تصویری نامعتبر می‌باشد.',
    ...
    'enum' => 'مقدار :attribute قابل قبول نیست.',
    'exists' => ':attribute انتخاب شده، معتبر نیست.',
    'file' => ':attribute باید یک فایل باشد',
    'filled' => 'فیلد :attribute الزامی است',
    'gt' => [
        'numeric' => 'فیلد :attribute باید بزرگتر از صفر باشد.',
    ...
    */
    ...
    'attributes' => [
        ...
        'color' => 'رنگ',
        'otp' => 'رمز یکبار مصرف',
        'profile_image' => 'عکس کاربری',
        'property_type_id' => 'نوع خانه',
        'lat' => 'مختصات نقشه',
        'lng' => 'مختصات نقشه',
        'amount' => 'مبلغ',
        'rrn' => 'شناسه پرداخت',
        ...
        'receive_subject' => 'موضوع دریافت',
        'project_id' => 'کد پروژه',
        'imprest_number' => 'شماره تنخواه',
        'start_date' => 'تاریخ شروع',
        'end_date' => 'تاریخ پایان',
        'file' => 'فایل',
        'server' => 'سرور',
        'error' => 'خطا!',
        'image_count' => 'تعداد پیوست',
        ...
        'jdatetime' => ':attribute وارد شده زمان معتبری طبق فرمت :format نیست (مثال معتبر: :fa-sample).',
        'jdatetime_after' => ':attribute وارد شده باید زمان معتبری بعد از :fa-date باشد.',
        'jdatetime_before' => ':attribute وارد شده باید زمان معتبری قبل از :fa-date باشد.',

        'uuid_is_not_valid' => 'uuid وارد شده اشتباه است.',
    ],
    'jalali_date_not_valid' => 'تاریخ وارد شده صحیح نیست.',
];
