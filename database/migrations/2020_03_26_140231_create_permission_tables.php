...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        if (! Schema::connection('mysql')->hasTable($tableNames['permissions'])) {
        ...
        if (! Schema::connection('mysql')->hasTable($tableNames['roles'])) {
        ...
        if (! Schema::connection('mysql')->hasTable($tableNames['model_has_permissions'])) {
        ...
        if (! Schema::connection('mysql')->hasTable($tableNames['model_has_roles'])) {
        ...
        if (! Schema::connection('mysql')->hasTable($tableNames['role_has_permissions'])) {
    ...
    public function down()
    {
        ...
        Schema::connection('mysql')->dropIfExists($tableNames['role_has_permissions']);
        Schema::connection('mysql')->dropIfExists($tableNames['model_has_roles']);
        Schema::connection('mysql')->dropIfExists($tableNames['model_has_permissions']);
        Schema::connection('mysql')->dropIfExists($tableNames['roles']);
        Schema::connection('mysql')->dropIfExists($tableNames['permissions']);
    }
}
